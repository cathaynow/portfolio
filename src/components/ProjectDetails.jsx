...
const ProjectDetails = ({href, image, description, subDescription, title, tags, closeModal}) => {
    return (
        <div
                ...
                <div className="p-5">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <a className="inline-flex items-center gap-1 font-medium cursor-pointer hover-animation">
                            View Project <img src="/assets/arrow-up.svg" alt="size-4" className="size-4" href={href}/>
                        </a>
                    </div>
                </div>
            </motion.div>
