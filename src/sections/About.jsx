        ...
        <section className="c-space section-spacing" id="about">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
                ...
                <div className="flex items-end grid-default-color grid-1">
                    <img src="/assets/coding-pov.png" alt="coding-pov" className="absolute scale-[1.75] -right-[5rem] -top-[1rem]
                    ...
                    <div className="z-10">
                        ...
                        <p className="subtext">Over the last 4 years, I developed my frontend and backend dev
                            skills to deliver dynamic and responsive software and web applications.
                        </p>
                    </div>
                ...
                <div className="grid-default-color grid-2">
                    <div className="flex items-center justify-center w-full h-full" ref={grid2Container}>
                        ...
                        <Card text="SOLID" style={{rotate: "-30deg", top: "60%", left: "45%"}}
                              containerRef={grid2Container}/>
                        <Card text="Design Patterns" style={{rotate: "90deg", bottom: "30%", left: "70%"}}
                              containerRef={grid2Container}/>
                        ...
                        <Card image="/assets/logos/csharp-pink.png" style={{rotate: "30deg", top: "70%", left: "70%"}}
                              containerRef={grid2Container}/>
                        <Card image="/assets/logos/dotnet-pink.png"
                              style={{rotate: "-45deg", top: "70%", left: "25%"}} containerRef={grid2Container}/>
                        <Card
                            image="/assets/logos/blazor-pink.png"
                            style={{rotate: "-45deg", top: "5%", left: "10%"}} containerRef={grid2Container}/>
                ...
                <div className="grid-default-color grid-5">
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">I specialize in a variety of languages, frameworks, and tools taht allow
                            me to build robust and scalable applications</p>
                    </div>
